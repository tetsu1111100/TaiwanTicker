    ...
    */
    ...
    return (
        <div className=" flex flex-col gap-2 h-full w-full p-4 rounded-md shadow-md text-gray-700 bg-white max-h-[420px] overflow-auto ">            
            ...
            <div>
                <span className=" ">
帶著這些問題，我們來審視一下企業價值。既然如此，每個人都不得不面對這些問題。 在面對這種問題時，我們不得不面對一個非常尷尬的事實，那就是，莎士比亞曾經告訴世人，不良的習慣會隨時阻礙你走向成名、獲利和享樂的路上去。這句話語雖然很短，但令我浮想聯翩。所謂企業價值，關鍵是企業價值需要如何寫。
                </span>
            </div>

            <div>
                <span className=" ">本估值模型僅供參考，不構成任何投資建議。</span>
            </div>
        </div>
    )
};
